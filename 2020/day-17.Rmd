...
Just doing that much shrunk the run-time from 2 hours 35 minutes to ~17 minutes! I can do better though, I think - in Day 11's final approach, I arranged things into a matrix and approached it from there - I think I can definitely do the same here!
...
count_neighbours_4d <- function(indices){
  ...
  i <- indices %>%
    mutate(neighbours = pmap_dbl(list(x,y,z,w),check_each_neighbour,a))

    
  return(i)
}

check_each_neighbour <- function(x, y, z, w, array){
...
```
```
2020-12-17 18:07:04 900
1 2020-12-17 18:07:07 3600
2 2020-12-17 18:07:22 9604
3 2020-12-17 18:08:01 20736
4 2020-12-17 18:09:24 39204
5 2020-12-17 18:12:02 67600
6 2020-12-17 18:16:36 108900

[1] 1696
```

Shaving another ~six minutes off, finishes in about nine minutes.
