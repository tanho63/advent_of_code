...
```
```{r echo = FALSE}
message("1 2020-12-17 10:26:13")
message("2 2020-12-17 10:26:16")
message("3 2020-12-17 10:26:22")
message("4 2020-12-17 10:26:33")
message("5 2020-12-17 10:26:52")
message("6 2020-12-17 10:27:23")
...
count_neighbours_4d <- function(x, y, z, w, indices) {
  ...
  neighbours <- crossing(
    ...
    filter(
      !(.data$x == .env$x & .data$y == .env$y & .data$z == .env$z & .data$w == .env$w),
      between(.data$x, 1, x_max),
      between(.data$y, 1, y_max),
      between(.data$z, 1, z_max),
      between(.data$w, 1, w_max)
    ) %>%
    mutate(value = pmap_dbl(list(x, y, z, w), ~ indices$value[indices$x == ..1 & indices$y == ..2 & indices$z == ..3 & indices$w == ..4])) %>%
    pull(value) %>%
    sum()
...
```
```{r echo = FALSE}
message("2020-12-17 02:01:36 900")
message("1 2020-12-17 02:01:41 3600")
message("2 2020-12-17 02:02:12 9604")
message("3 2020-12-17 02:04:46 20736")
message("4 2020-12-17 02:15:10 39204")
message("5 2020-12-17 02:50:04 67600")
message("6 2020-12-17 04:35:08 108900")
