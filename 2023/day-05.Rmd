...
Brute force, one layer with crude searching and then coming back to refine the seed later
...
```
```{r echo=FALSE}
structure(list(seed = c(443637926, 443687926, 443737926), location = c(776625416, 
57457888, 57507888)), row.names = c(NA, -3L), class = c("tbl_df", 
"tbl", "data.frame"))
```
```{r eval = FALSE}
