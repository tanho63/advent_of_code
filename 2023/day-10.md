...
Triple the resolution of the grid, then for each value of the pipe
ensure that the corresponding are set correctly, then flood-fill it.
Then find grid coordinates where all nine points are inside the
corresponding triple-resolution grid.
